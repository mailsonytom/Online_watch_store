                    ...
                    <?php
                        if ($num_rows > 0) {
                            ...
                            <div class="alert alert-success" role="alert">
                                ...
                                <span class="badge badge-warning"><?php echo $a['location']; ?></span>
                                <span class="badge badge-danger"><a class="text-light" href="revoke.php?id=<?php echo $a['id']; ?>">Revoke access</a></span>
                                <hr>
